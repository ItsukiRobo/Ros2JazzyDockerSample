#ifndef SIGNAL_UTILITY__HIGH_PASS_FILTER_HPP_
#define SIGNAL_UTILITY__HIGH_PASS_FILTER_HPP_

namespace signal_utility
{

class BilinearHighPassFilter
{
public:
  BilinearHighPassFilter(double cutoff_frequency_hz = 0.0, double sampling_period_s = 0.0);
...
#endif  // SIGNAL_UTILITY__HIGH_PASS_FILTER_HPP_
